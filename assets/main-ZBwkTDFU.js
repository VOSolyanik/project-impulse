import{a as E}from"./vendor-4jich7g5.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(s){if(s.ep)return;s.ep=!0;const n=t(s);fetch(s.href,n)}})();const y=E.create({baseURL:"https://your-energy.b.goit.study/api"}),A=async r=>(await y.get("/exercises",{params:r})).data,M=async r=>(await y.get(`/exercises/${r}`)).data;class O{constructor(e,t=!1,i){this.containerElement=e,this.withDelete=t,this.emptyStateMessage=i,this.emptyStateElement=null,this.createItemTemplate=s=>{const n=s.name?s.name.charAt(0).toUpperCase()+s.name.slice(1):"";return`
